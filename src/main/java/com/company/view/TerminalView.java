...
//        multiSign(30, "\n");
    ...
    public static void clearScreenWithFlush() {
        System.out.print("\033[H\033[2J");
        System.out.flush();
    }

    public static void clearScreenWithSouts() {
        System.out.println(multiSign(30, "\n"));
        System.out.print("\033[H\033[2J");
        System.out.flush();
    }

    public static void printStringWithColourCyan(String message) {
